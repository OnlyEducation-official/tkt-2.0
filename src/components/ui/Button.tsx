...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-lg shadow-black/20 hover:bg-[hsl(var(--brand-green-hover))]",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        outline:
          "border border-border bg-transparent text-foreground hover:border-brand-yellow/70 hover:bg-secondary",
        ghost:
          "text-foreground hover:bg-secondary/80",
        gold:
          "bg-brand-yellow text-brand-black shadow-lg shadow-black/20 hover:bg-brand-yellow/90"
      },
      size: {
        default: "h-11 px-6",
        sm: "h-9 px-4 text-xs",
